        ...
        <Paper className={classes.paper}>
          ...
          <VCERNPieChart
            data={[
              ...
              {
                name: "Balance",
                value: stats?.current_event_money,
                color: "#FE9900",
              },
            ]}
          />
      ...
      <Grid item xs={12}>
        ...
        <div className={classes.inline}>
          <div style={{ marginRight: 25 }}>
            <VCERNButton
              fullWidth
              startIcon={icons.requests}
              value="Request New Pool "
      ...
      {!!events.length && (
        <>
          <VCERNTypography
            variant="h5"
            className={classes.inviteText}
            value={`${selectedPool.default ? "Deceased" : "Events"} Info`}
          />
