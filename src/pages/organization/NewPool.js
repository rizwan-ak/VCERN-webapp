...
import { contributionFequencyList, formatContributionFequency } from '../../common/data';
...
const useStyles = makeStyles(theme => ({
    ...
    remberMeContainer: { display: 'flex', alignItems: 'center', width: '100%', marginBottom: 10 },
}));

function NewPool({ requestNewPool, token, setCurrentPageTitle }) {
    ...
    const handleSubmit = () => {
        requestNewPool({ ...data, recurring_frequency: formatContributionFequency[recurring_frequency] }, token, () => {
    ...
    return (
        <Grid container spacing={3}>
            ...
            <VCERNTypography variant="body1" value="Contribution frequency *" className={classes.title} />
