...
function ManageGroups({
  ...
  const handleTriggerEvent = () => {
    triggerEvent(
      {
        member_id,
        pool_id: selectedPool?._id,
        title: cause_death,
        description: place_death,
      },
      token,
      () => {
        setSuccessMessage("Notification Sent Successfully.");
    ...
    <Grid container spacing={3}>
      ...
      <Grid item xs={12}>
        <VCERNTypography
          ...
          variant="h5"
          value={`Trigger ${
            selectedPool.default ? "Death" : ""
          } Announcement & Contribution Collection `}
        />
        <VCERNTextField
          variant="outlined"
        ...
        <VCERNButton
          fullWidth
          startIcon={icons.trigger}
          value="Trigger"
          disabled={disableEventTriggerButton}
