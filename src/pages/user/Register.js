...
function UserRegister({
  ...
  const [isUppercaseIncludedInPassword, setIsUppercaseIncludedInPassword] =
    useState(false);
  const [isLowercaseIncludedInPassword, setIsLowercaseIncludedInPassword] =
    useState(false);
  const [
    isSpecialCharacterIncludedInPassword,
    setIsSpecialCharacterIncludedInPassword,
  ] = useState(false);
  ...
  const handleOnChange = (evt) => {
    ...
    if (name === "password") {
      ...
      password && constants.UPPERCASE_REGEX.test(value)
        ? setIsUppercaseIncludedInPassword(true)
        : setIsUppercaseIncludedInPassword(false);
      password && constants.LOWERCASE_REGEX.test(value)
        ? setIsLowercaseIncludedInPassword(true)
        : setIsLowercaseIncludedInPassword(false);
      constants.SPECIAL_CHARACTER_REGEX.test(value)
        ? setIsSpecialCharacterIncludedInPassword(true)
        : setIsSpecialCharacterIncludedInPassword(false);
    }
  };
  ...
  const handleStep2Next = () => {
    if (!city || !state || !street_address || !zip_code || !organization)
      return setError("Please enter all required fields.");
    setActiveStep(2);
  };
  ...
  const handleSubmit = async (evt) => {
    if (!agreedTerms)
      return setError("Please accept Terms & Conditions to proceed");
    evt.preventDefault();
    ...
    if (error) {
      ...
      register({ ...data, payment_method: paymentMethod.id }, type, () =>
        history.push("/verify")
      );
    }
  };
  ...
  const step1 = (
    <div className={classes.container}>
      ...
      <InputMask
        ...
        className={classes.input}
        value={phone}
        onChange={(c) => setData({ ...data, phone: c.target.value })}
        maskChar=" "
      >
      ...
      <VCERNTypography
        ...
        align="left"
        className={
          isPasswordLengthValid ? classes.activeText : classes.inActiveText
        }
      >
      ...
      >
        <CheckCircle fontSize="small" style={{ marginRight: 8 }} />1 upper case
        letter
      </VCERNTypography>
      <VCERNTypography
        variant="body1"
      ...
      >
        <CheckCircle fontSize="small" style={{ marginRight: 8 }} />1 lower case
        atleast
      </VCERNTypography>
      <VCERNTypography
        variant="body1"
      ...
      >
        <CheckCircle fontSize="small" style={{ marginRight: 8 }} />1 number or
        special character atleast
      </VCERNTypography>
  ...
  const step2 = (
    <div className={classes.container}>
      ...
      <div className={classes.inline}>
        <div style={{ width: "46%" }}>
          <VCERNButton
            fullWidth
            variant="outlined"
            className={cx({ [classes.borderedButton]: gender === "male" })}
            onClick={() => setData({ ...data, gender: "male" })}
          >
            <Check
              className={
                gender === "male" ? classes.activeTickIcon : classes.tickIcon
              }
            />
            Male
          </VCERNButton>
        ...
        <div style={{ width: "46%" }}>
          ...
          >
            <Check
              className={
                gender === "female" ? classes.activeTickIcon : classes.tickIcon
              }
            />
            Female
          </VCERNButton>
      ...
      <InputMask
        ...
        className={classes.input}
        value={zip_code}
        onChange={(c) => setData({ ...data, zip_code: c.target.value })}
        maskChar={null}
      >
  ...
  const step3 = (
    <div className={classes.container}>
      ...
      <InputMask
        ...
        className={classes.input}
        value={b_phone}
        onChange={(c) => setData({ ...data, b_phone: c.target.value })}
        maskChar=" "
      >
        {() => <VCERNTextField label="Phone Number *" icon={icons.phone} />}
      </InputMask>
      ...
      <InputMask
        ...
        className={classes.input}
        value={b_zip_code}
        onChange={(c) => setData({ ...data, b_zip_code: c.target.value })}
        maskChar={null}
      >
        {() => <VCERNTextField label="Zip Code *" icon={icons.zip} />}
      </InputMask>
    ...
    <div className={classes.container}>
      ...
      <VCERNTypography variant="body1" className={classes.text}>
        ...
        <VCERNTypography
          variant="body1"
          component="span"
          value={`$${userSubscriptionPrice}/yr`}
        />
      </VCERNTypography>
      ...
      <VCERNTypography variant="body2">
        ...
        <VCERNTypography
          ...
          color="primary"
          component="span"
          value={userSubscriptionPrice}
        />{" "}
        by vCERN for your yearly membership. Your card will be subsequently
        charged the same fee every year unless you cancel or is no longer a part
        of this pool. Additionally, after a waiting period of 3 months, your{" "}
        <VCERNTypography
          variant="body2"
          component="span"
          color="primary"
        ...
        <VCERNTypography
          ...
          value={userSubscriptionPrice}
        />{" "}
        for your contribution toward the next death. Every time someone passes
        away you’ll charge a contribution.
      </VCERNTypography>

      <VCERNTypography
        variant="body1"
        className={classes.text}
        value="You’ll be eligible to collect $20,000 in the event of your passing."
      />
      ...
      <div className={classes.remberMeContainer}>
        <Checkbox
          ...
          checked={agreedTerms}
          onChange={(evt) =>
            setData({ ...data, agreedTerms: evt.target.checked })
          }
        />
        <VCERNTypography variant="body1" className={classes.text}>
...
export default connect((data) => data, {
  ...
  fetchOrganizations: AC.fetchOrganizations,
})(UserRegister);
